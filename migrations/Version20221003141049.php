 ...
 */
final class Version20221003141049 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE party (id INT AUTO_INCREMENT NOT NULL, gamemod_id INT NOT NULL, token VARCHAR(500) NOT NULL, INDEX IDX_89954EE08B85B4DE (gamemod_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
